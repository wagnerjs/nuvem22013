...
public class TestInstanceMethods{
	...
	/**
	 * Gerncia de Ciclo de Vida das Inst‰ncias:
	 * BundleInstance - PENDING
...
//		
//		try{
//			BundleInstanceRequest bundleInstReq = new BundleInstanceRequest(instanceId, null);
//			ec2.bundleInstance(bundleInstReq);			
